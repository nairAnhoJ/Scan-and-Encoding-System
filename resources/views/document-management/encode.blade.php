    ...
    <div class="p-5 flex flex-row h-full">
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500">Save Changes?</h3>
                        <button id="btnYes" data-modal-toggle="popup-modal" type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm inline-flex items-center px-8 py-2.5 text-center mr-2">Yes</button>
                        <button data-modal-toggle="popup-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-8 py-2.5 hover:text-gray-900 focus:z-10">No</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-2/6 min-h-full">
            <div style="border: 1px solid #0284c7;" class="h-full">
                <div>
                    <h2 class="text-sky-600 text-xl font-bold pl-3 py-1">Encode</h2>
